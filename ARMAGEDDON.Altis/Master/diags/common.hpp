class RscShortcutButton
{
	...
	borderSize = 0;
	animTextureNormal = "Master\img\bt_n.jpg";
	animTextureDisabled = "Master\img\bt_d.jpg";
	animTextureOver = "Master\img\bt_h.jpg";
	animTextureFocused = "Master\img\bt_n.jpg";
	animTexturePressed = "Master\img\bt_p.jpg";
	animTextureDefault = "Master\img\bt_n.jpg";
	period = 0;
	periodFocus = 0;
	periodOver = 0;
	shortcuts[] = {};
	textureNoShortcut = "Master\img\bt_n.jpg";
	color[] = {0,0,0,1};
	color2[] = {0,0,0,1};
