...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "intro": {_var = "license_civ_intro"};
			case "intro1": {_var = "license_cop_intr1"};
			case "intro2": {_var = "license_med_intr2"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_intro": {_var = "intro"};
			case "license_cop_intro1": {_var = "intro1"};
			case "license_med_intro2": {_var = "intro2"};
			default {_var = ""};
		};
	};
};
