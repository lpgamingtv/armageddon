...
r3_reviveBleedOutTime = 420;                  // Seconds | Make sure Dead bodys will not deleted unitil this time !
...
r3_reviveEnableAiRevive = false;               // enable AI Revive (Ai can revive player but also other AI units)
...
[
	...
	["license_civ_intro","civ"],
	["license_cop_intro1","cop"],
	["license_med_intro2","med"]
